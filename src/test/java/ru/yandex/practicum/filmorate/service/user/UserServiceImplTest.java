...
@ContextConfiguration(classes = {UserDbStorage.class, FilmRowMapper.class, FilmDbStorage.class, UserRowMapper.class, EventDbStorage.class, EventRowMapper.class})
